    ...
    <>
      {dummyEnablees.map((enablee, i) => {
        ...
        return (
          ...
          >
            <p className="grid-child row-id">{enablee.employeeId}</p>
            <p className="grid-child">{enablee.firstName}</p>
            <p className="grid-child">{enablee.lastName}</p>
            <Tooltip
            ...
            <button
              ...
              className="delete-row-button grid-child"
              onClick={(event) => {
