      ...
      <Table stickyHeader aria-label="sticky table">
        ...
        <TableBody>
          {rows.map((r:string[], index:number) => (
            <CustomTableRow key={index} rowId={index.toString()} row={r} rowStyle={rowStyle} cellStyle={cellStyle} index={index} customHandleSelection={customHandleSelection} updateSelectedEnablees={updateSelectedEnablees}/>
          ))}
        </TableBody>
      </Table>
    </TableContainer>
